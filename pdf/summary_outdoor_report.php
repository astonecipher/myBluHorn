...
$pdf->SetTitle('Outdoor Summary');
$pdf->SetSubject('Outdoor Summary Report');
$pdf->SetKeywords('');

// set default header data
//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Outdoor Insertion Order", PDF_HEADER_STRING);
...
$pdf->Write(0, 'Outdoor Summary', '', 0, 'L', true, 0, false, false, 0);
