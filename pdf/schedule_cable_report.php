...
$pdf->SetTitle('Cable Schedule');
$pdf->SetSubject('Cable Schedule');
$pdf->SetKeywords('');

// set default header data
//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Cable Schedule", PDF_HEADER_STRING);
...
$totalGRPsPerWorksheetWeek = array();
...
$pdf->Write(0, 'Cable Schedule', '', 0, 'L', true, 0, false, false, 0);
...
<th style="text-align: center; width: 100px; $borderBottomStr" nowrap>Program</th>
EOD;
...
EOD;
	...
	$vendors = unique($lines, "vendorID", true);
...
foreach ($vendors as $vendor) {
  foreach ($stations as $station) {
	...
	$totalGRPsPerWeekByStation = array();
