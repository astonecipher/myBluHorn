...
$pdf->SetTitle('Cable Insertion Order');
...
$pdf->SetXY(4,3,true);
$pdf->Write(0, 'Cable TV Order', '', 0, 'L', true, 0, false, false, 0);
...
<th width="120" style="width: 120px; $borderBottomStr" nowrap>Program Title & Zone</th>
