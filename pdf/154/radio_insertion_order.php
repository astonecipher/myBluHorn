...
$pdf->SetTitle('Radio Insertion Order');
$pdf->SetSubject('Insertion Order');
$pdf->SetKeywords('');

// set default header data
//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Radio Insertion Order", PDF_HEADER_STRING);
...
$pdf->SetXY(4,3,true);
$pdf->Write(0, 'Radio Station Order', '', 0, 'L', true, 0, false, false, 0);
...
$linetbl .= <<<EOD
<td style="width: 50px; text-align: center;">{$wsWeeks[$displayedLine][$weekCounter]}</td>
EOD;
...
$tbl .= <<<EOD
<th style="width: 50px; text-align: center;">{$weekSummary[$week]["totalSpots"]}<br>$weeklyAQHStr</th>
EOD;
...
$summary = <<<EOD
<strong>Station Summary</strong><br><br><table cellspacing="0" cellpadding="1" border="1" style="margin-right: 10px; width: 500px;">
	<thead>
    	<tr>
