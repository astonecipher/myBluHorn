...
$pdf->SetTitle('Radio Schedule');
$pdf->SetSubject('Radio Schedule');
$pdf->SetKeywords('');

// set default header data
//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Radio Schedule", PDF_HEADER_STRING);
...
$pdf->Write(0, 'Radio Schedule', '', 0, 'L', true, 0, false, false, 0);
