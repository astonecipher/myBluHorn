...
EOD;
	...
	if ($totalLinesOnPage + $headerLineCount > 21){
		if ($printedLines > 0) {	
...
$tbl .= <<<EOD
<th style="width: 50px; text-align: center;">{$weekSummary[$week]["totalSpots"]}
EOD;
...
$tbl .= <<<EOD
<th style="$borderBottomStr text-align: center;"> $totalSpotsPerTable
EOD;

if ($orderDetails["aqhRating"]) {
$tbl .= <<<EOD
<br>$totalGRPsPerTable</th>	
EOD;
}
