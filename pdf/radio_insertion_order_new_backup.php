...
<table cellspacing="0" cellpadding="1" border="$border" style="margin-right: 10px;">
    <tr>
        ...
        <td rowspan="6" style="text-align: right;">Buyer: {$buyer["name"]}<br>{$buyer["emailAddress"]} <br />$jobNumberStr $jobNumber<br /></td>
    </tr>
</table>
EOD;
...
if (! $hiddenCols["cume"]) {
$tbl .= <<<EOD
<th style="$borderBottomStr">Cume</th>
EOD;
$totalCols++;
}
...
<table cellspacing="0" cellpadding="1" border="$border" style="margin-right: 10px;">
    <tr>
        ...
        <td rowspan="1" style="text-align: left;"><strong>Buyer</strong><br />{$buyer["name"]}<br>{$buyer["emailAddress"]}</td>
    </tr>
</table>
EOD;
