...
<th style="width: 100px;$borderBottomStr"><strong>Net Cost</strong></th>
</tr></thead>
<tbody>
EOD;
...
<td style="">{$line["totalCost"]}</td>
<td style="">{$line["netCost"]}</td></tr>
EOD;
...
<table cellspacing="0" cellpadding="1" border="$border" style="margin-right: 10px;">
    <tr>
        <td rowspan="1"><strong>Comments:</strong><br /><h6>{$orderInfo["comments"]} {$agencyInfo["comments"]}</h6></td>
