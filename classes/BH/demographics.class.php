...
{  
	...
	public function getAllDemographics($demoID) {
		$demoIDStr = $this->db->quote($demoID);
		
		$r=$this->db->query("select * from BH_DEMOGRAPHIC where demographicID = $demoIDStr order by gender asc, ageFrom asc");
