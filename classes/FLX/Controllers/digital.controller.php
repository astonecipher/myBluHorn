...
/**
 * FILELOGIX BLUHORN DIGITAL WORKSHEET CLASS
 *  
 * @author Wes Benwick
...
{  
	...
	private $cols = array("agencyID"=>"agencyID", "worksheetID"=>"worksheetID", "lineNumber"=>"worksheetLine", "cols"=>"numberOfColumns", "vendor"=>"vendorName", "vendorID"=>"vendorID", "grossCPI"=>"grossCPI", "inches"=>"inches", "grossTotal"=>"grossCost", "netCPI"=>"netCPI", "netTotal"=>"netCost", "size"=>"printSize", "caption"=>"caption", "insertionDate"=>"insertionDate", "startDate"=>"startDate", "endDate"=>"endDate", "color"=>"color", "position"=>"positionRequest", "deadline"=>"creativeDeadline", "comments"=>"comments", "bold"=>"isBold", "isIgnored"=>"isIgnored", "copy"=>"isCopy", "delete"=>"isDeleted", "isIgnored"=>"isIgnored");
...
*/	
	...
	public function dflt() {
	  if ($this->auth->validate($this->userID)) {
		...
		$this->view = "worksheet-digital-alt";
...
//	  }
	...
	if ($this->auth->validate($this->userID)) {
		...
		if ($this->userID == 1) {
			$this->view = "worksheet-digital-alt-new";
		}
