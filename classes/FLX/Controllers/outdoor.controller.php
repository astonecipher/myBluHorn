...
/**
 * FILELOGIX BLUHORN OUTDOOR WORKSHEET CLASS
 *  
 * @author Wes Benwick
...
{  
	...
	private $fields = array("campaignID"=>"campaignID", "worksheetName"=>"name", "marketType"=>"typeID", "markets"=>"marketID", "agencyID"=>"agencyID", "commission"=>"commission");
	private $cols = array("agencyID"=>"agencyID", "worksheetID"=>"worksheetID", "lineNumber"=>"worksheetLine",  "vendor"=>"vendorName", "vendorID"=>"vendorID", "boardCost"=>"boardCost", "productionCost"=>"productionCost", "totalCost"=>"totalCost", "netTotal"=>"netCost", "size"=>"boardSize", "qty"=>"numberOfBoards", "name"=>"name", "insertionDate"=>"insertionDate", "type"=>"type", "location"=>"location", "deadline"=>"artworkDeadline", "comments"=>"comments", "bold"=>"isBold", "isIgnored"=>"isIgnored", "copy"=>"isCopy", "delete"=>"isDeleted", "isIgnored"=>"isIgnored");
...
*/	
	...
	public function dflt() {
	  if ($this->auth->validate($this->userID)) {
		...
		$this->view = "worksheet-outdoor-alt";
