...
/**
 * FILELOGIX BLUHORN RADIO WORKSHEET CLASS
 *  
 * @author Wes Benwick
...
{  
	...
	private $editor;
	private $type;
	private $dayparts = array("none"=>"-", "am"=>"AM", "md"=>"MD", "pm"=>"PM", "ev"=>"EV", "we"=>"WE", "ov"=>"OV", "ro"=>"RO"); 
	...
	private $cols = array("agencyID"=>"agencyID", "worksheetID"=>"worksheetID", "lineNumber"=>"worksheetLine", "daypart"=>"daypart", "vendor"=>"vendorName", "vendorID"=>"vendorID", "station"=>"station", "cume"=>"cume", "timeOfDay"=>"timePeriod", "program"=>"programName", "mon"=>"isMonday", "tue"=>"isTuesday", "wed"=>"isWednesday", "thu"=>"isThursday", "fri"=>"isFriday", "sat"=>"isSaturday", "sun"=>"isSunday", "length"=>"seconds", "rate"=>"rate", "aqh"=>"aqhRating", "impact"=>"impact", "comments"=>"comments", "bold"=>"isBold", "cpp"=>"cpp", 
...
*/	
	...
	public function dflt() {
	  if ($this->auth->validate($this->userID)) {
		...
		$this->view = "worksheet-radio-alt-simple";
...
*/
	...
	public function copy($params) {
	 ...
	 if ($this->auth->validate($this->userID)) {
	    ...
	    $id = $worksheet->copyWorksheet($worksheetID, $campaignID);			

	    error_log("BH Copy: $id");
